...
Документация REST API для конфигураций, разработанных на базе [TDMS](https://tdms.ru) (Technical Data Management System ) с использованием приложения TDMS Application Server.
Текущая поддерживаемая версия `6.1.145.0`
...
|APIEventFilters|[JParam](#JParam)  |Задает фильтры для получения специальных событий
...
|Parameter |Type  |Required|Description
|-         |-     |-       |-               
|From      |string|        |Возвращать события начиная с этой временной точки (включая её) (UTC)
|Before    |string|        |Возвращать события начиная до этой временной точки (не включая её) (UTC)
...
|404 NotFound  |Не найдена функция расширения, либо недостаточно прав для её вызова
